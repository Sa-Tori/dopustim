...
client.on("message", (msg) => {
    ...
    if ((msg.content.toLowerCase().indexOf("523116257390886954") != -1 || msg.content.toLowerCase().indexOf("картус") != -1 || msg.channel.id === "591607946107158538") && msg.content.toLowerCase().indexOf("?") != -1) {
