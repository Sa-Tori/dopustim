...
msg.react("768469943288332299");
    ...
    if (msg.author.id === "542663623789641729" && (getRandom(1, 14) == 4) && msg.content.toLowerCase().indexOf("нов") == -1 && msg.content.toLowerCase().indexOf("год") == -1) {
    ...
    if ((getRandom(0, 4) == 1) && msg.content.length == 0
